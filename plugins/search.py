...
async def search(bot, message):
    ...
    try:
       ...
       if bool(results)==False:
          ...
          msg = await message.reply_photo(photo="https://i.postimg.cc/6p8PQYs4/IMG-20250627-181735-630.jpg",
...
async def recheck(bot, update):
    ...
    head    = "<u>⭕ আমি ভুল বানান সহ সিনেমাটি অনুসন্ধান করেছি কিন্তু পরের বার সাবধান থাকবেন। 👇\n\n💢 Powered By </u> <b><I>@YABOTZ ❗</I></b>\n\n"
    results = ""
    try:
       for channel in channels:
           async for msg in User.search_messages(chat_id=channel, query=query):
